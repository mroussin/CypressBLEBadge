...
#define SPI_Master_REMOVE_SPI_MASTER_MISO_PIN     (1u)
...
***************************************/
    ...
    #define SPI_Master_RX_SDA_MOSI_HSIOM_SEL_GPIO  (SPI_Master_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define SPI_Master_RX_SDA_MOSI_HSIOM_SEL_I2C   (SPI_Master_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define SPI_Master_RX_SDA_MOSI_HSIOM_SEL_SPI   (SPI_Master_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define SPI_Master_RX_SDA_MOSI_HSIOM_SEL_UART  (SPI_Master_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (SPI_Master_RX_WAKE_SDA_MOSI_PIN)
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_MASK      (SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_POS       (SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define SPI_Master_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define SPI_Master_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SPI_Master_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SPI_Master_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (SPI_Master_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define SPI_Master_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) SPI_Master_INTCFG_TYPE_MASK << \
                                                                           SPI_Master_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins SPI_Master_RX_SDA_MOSI_PIN or SPI_Master_RX_WAKE_SDA_MOSI_PIN present.*/
    ...
    #define SPI_Master_TX_SCL_MISO_HSIOM_SEL_GPIO  (SPI_Master_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define SPI_Master_TX_SCL_MISO_HSIOM_SEL_I2C   (SPI_Master_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define SPI_Master_TX_SCL_MISO_HSIOM_SEL_SPI   (SPI_Master_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define SPI_Master_TX_SCL_MISO_HSIOM_SEL_UART  (SPI_Master_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
    ...
    #define SPI_Master_CTS_SCLK_HSIOM_SEL_GPIO  (SPI_Master_uart_cts_spi_sclk__0__HSIOM_GPIO)
    #define SPI_Master_CTS_SCLK_HSIOM_SEL_I2C   (SPI_Master_uart_cts_spi_sclk__0__HSIOM_I2C)
    #define SPI_Master_CTS_SCLK_HSIOM_SEL_SPI   (SPI_Master_uart_cts_spi_sclk__0__HSIOM_SPI)
    #define SPI_Master_CTS_SCLK_HSIOM_SEL_UART  (SPI_Master_uart_cts_spi_sclk__0__HSIOM_UART)
    ...
    #define SPI_Master_RTS_SS0_HSIOM_SEL_GPIO  (SPI_Master_uart_rts_spi_ss0__0__HSIOM_GPIO)
    #define SPI_Master_RTS_SS0_HSIOM_SEL_I2C   (SPI_Master_uart_rts_spi_ss0__0__HSIOM_I2C)
    #define SPI_Master_RTS_SS0_HSIOM_SEL_SPI   (SPI_Master_uart_rts_spi_ss0__0__HSIOM_SPI)
#if !(SPI_Master_CY_SCBIP_V0 || SPI_Master_CY_SCBIP_V1)
    #define SPI_Master_RTS_SS0_HSIOM_SEL_UART  (SPI_Master_uart_rts_spi_ss0__0__HSIOM_UART)
    ...
    #define SPI_Master_SS1_HSIOM_SEL_GPIO (SPI_Master_spi_ss1__0__HSIOM_GPIO)
    #define SPI_Master_SS1_HSIOM_SEL_I2C  (SPI_Master_spi_ss1__0__HSIOM_I2C)
    #define SPI_Master_SS1_HSIOM_SEL_SPI  (SPI_Master_spi_ss1__0__HSIOM_SPI)
#endif /* (SPI_Master_SS1_PIN) */
    ...
    #define SPI_Master_SS2_HSIOM_SEL_GPIO (SPI_Master_spi_ss2__0__HSIOM_GPIO)
    #define SPI_Master_SS2_HSIOM_SEL_I2C  (SPI_Master_spi_ss2__0__HSIOM_I2C)
    #define SPI_Master_SS2_HSIOM_SEL_SPI  (SPI_Master_spi_ss2__0__HSIOM_SPI)
#endif /* (SPI_Master_SS2_PIN) */
    ...
    #define SPI_Master_SS3_HSIOM_SEL_GPIO (SPI_Master_spi_ss3__0__HSIOM_GPIO)
    #define SPI_Master_SS3_HSIOM_SEL_I2C  (SPI_Master_spi_ss3__0__HSIOM_I2C)
    #define SPI_Master_SS3_HSIOM_SEL_SPI  (SPI_Master_spi_ss3__0__HSIOM_SPI)
#endif /* (SPI_Master_SS3_PIN) */
    ...
    #define SPI_Master_SCL_HSIOM_SEL_GPIO (SPI_Master_sda__0__HSIOM_GPIO)
    #define SPI_Master_SCL_HSIOM_SEL_I2C  (SPI_Master_sda__0__HSIOM_I2C)
    ...
    #define SPI_Master_SDA_HSIOM_SEL_GPIO (SPI_Master_sda__0__HSIOM_GPIO)
    #define SPI_Master_SDA_HSIOM_SEL_I2C  (SPI_Master_sda__0__HSIOM_I2C)
#endif /* (SPI_Master_I2C_PINS) */

#if (SPI_Master_SPI_SLAVE_PINS)
    #define SPI_Master_SCLK_S_HSIOM_REG   (*(reg32 *) SPI_Master_sclk_s__0__HSIOM)
    #define SPI_Master_SCLK_S_HSIOM_PTR   ( (reg32 *) SPI_Master_sclk_s__0__HSIOM)
    
    #define SPI_Master_SCLK_S_HSIOM_MASK      (SPI_Master_sclk_s__0__HSIOM_MASK)
    #define SPI_Master_SCLK_S_HSIOM_POS       (SPI_Master_sclk_s__0__HSIOM_SHIFT)
    #define SPI_Master_SCLK_S_HSIOM_SEL_GPIO  (SPI_Master_sclk_s__0__HSIOM_GPIO)
    #define SPI_Master_SCLK_S_HSIOM_SEL_SPI   (SPI_Master_sclk_s__0__HSIOM_SPI)
    
    #define SPI_Master_SS0_S_HSIOM_REG    (*(reg32 *) SPI_Master_ss0_s__0__HSIOM)
    #define SPI_Master_SS0_S_HSIOM_PTR    ( (reg32 *) SPI_Master_ss0_s__0__HSIOM)
    
    #define SPI_Master_SS0_S_HSIOM_MASK       (SPI_Master_ss0_s__0__HSIOM_MASK)
    #define SPI_Master_SS0_S_HSIOM_POS        (SPI_Master_ss0_s__0__HSIOM_SHIFT)
    #define SPI_Master_SS0_S_HSIOM_SEL_GPIO   (SPI_Master_ss0_s__0__HSIOM_GPIO)  
    #define SPI_Master_SS0_S_HSIOM_SEL_SPI    (SPI_Master_ss0_s__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_SLAVE_PINS) */

#if (SPI_Master_SPI_SLAVE_MOSI_PIN)
    #define SPI_Master_MOSI_S_HSIOM_REG   (*(reg32 *) SPI_Master_mosi_s__0__HSIOM)
    #define SPI_Master_MOSI_S_HSIOM_PTR   ( (reg32 *) SPI_Master_mosi_s__0__HSIOM)
    
    #define SPI_Master_MOSI_S_HSIOM_MASK      (SPI_Master_mosi_s__0__HSIOM_MASK)
    #define SPI_Master_MOSI_S_HSIOM_POS       (SPI_Master_mosi_s__0__HSIOM_SHIFT)
    #define SPI_Master_MOSI_S_HSIOM_SEL_GPIO  (SPI_Master_mosi_s__0__HSIOM_GPIO)
    #define SPI_Master_MOSI_S_HSIOM_SEL_SPI   (SPI_Master_mosi_s__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_SLAVE_MOSI_PIN) */

#if (SPI_Master_SPI_SLAVE_MISO_PIN)
    #define SPI_Master_MISO_S_HSIOM_REG   (*(reg32 *) SPI_Master_miso_s__0__HSIOM)
    #define SPI_Master_MISO_S_HSIOM_PTR   ( (reg32 *) SPI_Master_miso_s__0__HSIOM)
    
    #define SPI_Master_MISO_S_HSIOM_MASK      (SPI_Master_miso_s__0__HSIOM_MASK)
    #define SPI_Master_MISO_S_HSIOM_POS       (SPI_Master_miso_s__0__HSIOM_SHIFT)
    #define SPI_Master_MISO_S_HSIOM_SEL_GPIO  (SPI_Master_miso_s__0__HSIOM_GPIO)
    #define SPI_Master_MISO_S_HSIOM_SEL_SPI   (SPI_Master_miso_s__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_SLAVE_MISO_PIN) */

#if (SPI_Master_SPI_MASTER_MISO_PIN)
    #define SPI_Master_MISO_M_HSIOM_REG   (*(reg32 *) SPI_Master_miso_m__0__HSIOM)
    #define SPI_Master_MISO_M_HSIOM_PTR   ( (reg32 *) SPI_Master_miso_m__0__HSIOM)
    
    #define SPI_Master_MISO_M_HSIOM_MASK      (SPI_Master_miso_m__0__HSIOM_MASK)
    #define SPI_Master_MISO_M_HSIOM_POS       (SPI_Master_miso_m__0__HSIOM_SHIFT)
    #define SPI_Master_MISO_M_HSIOM_SEL_GPIO  (SPI_Master_miso_m__0__HSIOM_GPIO)
    #define SPI_Master_MISO_M_HSIOM_SEL_SPI   (SPI_Master_miso_m__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_MASTER_MISO_PIN) */

#if (SPI_Master_SPI_MASTER_MOSI_PIN)
    #define SPI_Master_MOSI_M_HSIOM_REG   (*(reg32 *) SPI_Master_mosi_m__0__HSIOM)
    #define SPI_Master_MOSI_M_HSIOM_PTR   ( (reg32 *) SPI_Master_mosi_m__0__HSIOM)
    
    #define SPI_Master_MOSI_M_HSIOM_MASK      (SPI_Master_mosi_m__0__HSIOM_MASK)
    #define SPI_Master_MOSI_M_HSIOM_POS       (SPI_Master_mosi_m__0__HSIOM_SHIFT)
    #define SPI_Master_MOSI_M_HSIOM_SEL_GPIO  (SPI_Master_mosi_m__0__HSIOM_GPIO)
    #define SPI_Master_MOSI_M_HSIOM_SEL_SPI   (SPI_Master_mosi_m__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_MASTER_MOSI_PIN) */
    ...
    #define SPI_Master_SCLK_M_HSIOM_SEL_GPIO  (SPI_Master_sclk_m__0__HSIOM_GPIO)
    #define SPI_Master_SCLK_M_HSIOM_SEL_SPI   (SPI_Master_sclk_m__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_MASTER_SCLK_PIN) */
    ...
    #define SPI_Master_SS0_M_HSIOM_SEL_GPIO   (SPI_Master_ss0_m__0__HSIOM_GPIO)
    #define SPI_Master_SS0_M_HSIOM_SEL_SPI    (SPI_Master_ss0_m__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_MASTER_SS0_PIN) */
    ...
    #define SPI_Master_SS1_M_HSIOM_SEL_GPIO   (SPI_Master_ss1_m__0__HSIOM_GPIO)
    #define SPI_Master_SS1_M_HSIOM_SEL_SPI    (SPI_Master_ss1_m__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_MASTER_SS1_PIN) */
    ...
    #define SPI_Master_SS2_M_HSIOM_SEL_GPIO   (SPI_Master_ss2_m__0__HSIOM_GPIO)
    #define SPI_Master_SS2_M_HSIOM_SEL_SPI    (SPI_Master_ss2_m__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_MASTER_SS2_PIN) */
    ...
    #define SPI_Master_SS3_M_HSIOM_SEL_GPIO  (SPI_Master_ss3_m__0__HSIOM_GPIO)
    #define SPI_Master_SS3_M_HSIOM_SEL_SPI   (SPI_Master_ss3_m__0__HSIOM_SPI)
#endif /* (SPI_Master_SPI_MASTER_SS3_PIN) */

#if (SPI_Master_UART_RX_PIN)
    #define SPI_Master_RX_HSIOM_REG   (*(reg32 *) SPI_Master_rx__0__HSIOM)
    #define SPI_Master_RX_HSIOM_PTR   ( (reg32 *) SPI_Master_rx__0__HSIOM)
    
    #define SPI_Master_RX_HSIOM_MASK      (SPI_Master_rx__0__HSIOM_MASK)
    #define SPI_Master_RX_HSIOM_POS       (SPI_Master_rx__0__HSIOM_SHIFT)
    #define SPI_Master_RX_HSIOM_SEL_GPIO  (SPI_Master_rx__0__HSIOM_GPIO)
    #define SPI_Master_RX_HSIOM_SEL_UART  (SPI_Master_rx__0__HSIOM_UART)
#endif /* (SPI_Master_UART_RX_PIN) */

#if (SPI_Master_UART_RX_WAKE_PIN)
    #define SPI_Master_RX_WAKE_HSIOM_REG   (*(reg32 *) SPI_Master_rx_wake__0__HSIOM)
    #define SPI_Master_RX_WAKE_HSIOM_PTR   ( (reg32 *) SPI_Master_rx_wake__0__HSIOM)
    
    #define SPI_Master_RX_WAKE_HSIOM_MASK      (SPI_Master_rx_wake__0__HSIOM_MASK)
    #define SPI_Master_RX_WAKE_HSIOM_POS       (SPI_Master_rx_wake__0__HSIOM_SHIFT)
    #define SPI_Master_RX_WAKE_HSIOM_SEL_GPIO  (SPI_Master_rx_wake__0__HSIOM_GPIO)
    #define SPI_Master_RX_WAKE_HSIOM_SEL_UART  (SPI_Master_rx_wake__0__HSIOM_UART)
#endif /* (SPI_Master_UART_WAKE_RX_PIN) */

#if (SPI_Master_UART_CTS_PIN)
    #define SPI_Master_CTS_HSIOM_REG   (*(reg32 *) SPI_Master_cts__0__HSIOM)
    #define SPI_Master_CTS_HSIOM_PTR   ( (reg32 *) SPI_Master_cts__0__HSIOM)
    
    #define SPI_Master_CTS_HSIOM_MASK      (SPI_Master_cts__0__HSIOM_MASK)
    #define SPI_Master_CTS_HSIOM_POS       (SPI_Master_cts__0__HSIOM_SHIFT)
    #define SPI_Master_CTS_HSIOM_SEL_GPIO  (SPI_Master_cts__0__HSIOM_GPIO)
    #define SPI_Master_CTS_HSIOM_SEL_UART  (SPI_Master_cts__0__HSIOM_UART)
#endif /* (SPI_Master_UART_CTS_PIN) */

#if (SPI_Master_UART_TX_PIN)
    #define SPI_Master_TX_HSIOM_REG   (*(reg32 *) SPI_Master_tx__0__HSIOM)
    #define SPI_Master_TX_HSIOM_PTR   ( (reg32 *) SPI_Master_tx__0__HSIOM)
    
    #define SPI_Master_TX_HSIOM_MASK      (SPI_Master_tx__0__HSIOM_MASK)
    #define SPI_Master_TX_HSIOM_POS       (SPI_Master_tx__0__HSIOM_SHIFT)
    #define SPI_Master_TX_HSIOM_SEL_GPIO  (SPI_Master_tx__0__HSIOM_GPIO)
    #define SPI_Master_TX_HSIOM_SEL_UART  (SPI_Master_tx__0__HSIOM_UART)
#endif /* (SPI_Master_UART_TX_PIN) */

#if (SPI_Master_UART_RX_TX_PIN)
    #define SPI_Master_RX_TX_HSIOM_REG   (*(reg32 *) SPI_Master_rx_tx__0__HSIOM)
    #define SPI_Master_RX_TX_HSIOM_PTR   ( (reg32 *) SPI_Master_rx_tx__0__HSIOM)
    
    #define SPI_Master_RX_TX_HSIOM_MASK      (SPI_Master_rx_tx__0__HSIOM_MASK)
    #define SPI_Master_RX_TX_HSIOM_POS       (SPI_Master_rx_tx__0__HSIOM_SHIFT)
    #define SPI_Master_RX_TX_HSIOM_SEL_GPIO  (SPI_Master_rx_tx__0__HSIOM_GPIO)
    #define SPI_Master_RX_TX_HSIOM_SEL_UART  (SPI_Master_rx_tx__0__HSIOM_UART)
#endif /* (SPI_Master_UART_RX_TX_PIN) */
    ...
    #define SPI_Master_RTS_HSIOM_SEL_GPIO (SPI_Master_rts__0__HSIOM_GPIO)
    #define SPI_Master_RTS_HSIOM_SEL_UART (SPI_Master_rts__0__HSIOM_UART)    
#endif /* (SPI_Master_UART_RTS_PIN) */
...
/* The HSIOM values provided below are valid only for SPI_Master_CY_SCBIP_V0 
* and SPI_Master_CY_SCBIP_V1. It is not recommended to use them for 
* SPI_Master_CY_SCBIP_V2. Use pin name specific HSIOM constants provided 
...
#else
    #define SPI_Master_SET_I2C_SCL_DR(val)        do{ /* Does nothing */ }while(0)
    #define SPI_Master_SET_I2C_SCL_HSIOM_SEL(sel) do{ /* Does nothing */ }while(0)
...
#if (SPI_Master_RX_SDA_MOSI_PIN)
    #define SPI_Master_CLEAR_UART_RX_WAKE_INTR        do{ /* Does nothing */ }while(0)
    
#elif (SPI_Master_RX_WAKE_SDA_MOSI_PIN)
    #define SPI_Master_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) SPI_Master_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt(); \
            }while(0)

#elif(SPI_Master_UART_RX_WAKE_PIN)
    #define SPI_Master_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) SPI_Master_rx_wake_ClearInterrupt(); \
            }while(0)
#else
#endif /* (SPI_Master_RX_SDA_MOSI_PIN) */
