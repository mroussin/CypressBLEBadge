...
/* Unconfigured pins */
#define SPI_1_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define SPI_1_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define SPI_1_REMOVE_TX_SCL_MISO_PIN      (1u)
...
/* Unconfigured pins */
#define SPI_1_RX_WAKE_SDA_MOSI_PIN (0u == SPI_1_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define SPI_1_RX_SDA_MOSI_PIN     (0u == SPI_1_REMOVE_RX_SDA_MOSI_PIN)
#define SPI_1_TX_SCL_MISO_PIN     (0u == SPI_1_REMOVE_TX_SCL_MISO_PIN)
...
#if (SPI_1_RX_WAKE_SDA_MOSI_PIN)
    #include "SPI_1_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (SPI_1_RX_SDA_MOSI) */

#if (SPI_1_RX_SDA_MOSI_PIN)
    #include "SPI_1_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (SPI_1_RX_SDA_MOSI) */

#if (SPI_1_TX_SCL_MISO_PIN)
    #include "SPI_1_uart_tx_i2c_scl_spi_miso.h"
#endif /* (SPI_1_TX_SCL_MISO) */
...
#if (SPI_1_RX_SDA_MOSI_PIN)
    #define SPI_1_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define SPI_1_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    
    #define SPI_1_RX_SDA_MOSI_HSIOM_MASK      (SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define SPI_1_RX_SDA_MOSI_HSIOM_POS       (SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define SPI_1_RX_SDA_MOSI_HSIOM_SEL_GPIO  (SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define SPI_1_RX_SDA_MOSI_HSIOM_SEL_I2C   (SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define SPI_1_RX_SDA_MOSI_HSIOM_SEL_SPI   (SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define SPI_1_RX_SDA_MOSI_HSIOM_SEL_UART  (SPI_1_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (SPI_1_RX_WAKE_SDA_MOSI_PIN)
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_MASK      (SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_POS       (SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define SPI_1_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define SPI_1_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SPI_1_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) SPI_1_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SPI_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (SPI_1_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define SPI_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) SPI_1_INTCFG_TYPE_MASK << \
                                                                           SPI_1_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins SPI_1_RX_SDA_MOSI_PIN or SPI_1_RX_WAKE_SDA_MOSI_PIN present.*/
#endif /* (SPI_1_RX_SDA_MOSI_PIN) */

#if (SPI_1_TX_SCL_MISO_PIN)
    #define SPI_1_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define SPI_1_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    
    #define SPI_1_TX_SCL_MISO_HSIOM_MASK      (SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define SPI_1_TX_SCL_MISO_HSIOM_POS       (SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
    #define SPI_1_TX_SCL_MISO_HSIOM_SEL_GPIO  (SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define SPI_1_TX_SCL_MISO_HSIOM_SEL_I2C   (SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define SPI_1_TX_SCL_MISO_HSIOM_SEL_SPI   (SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define SPI_1_TX_SCL_MISO_HSIOM_SEL_UART  (SPI_1_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
#endif /* (SPI_1_TX_SCL_MISO_PIN) */
...
/* Pins settings index. */
#define SPI_1_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define SPI_1_RX_SDA_MOSI_PIN_INDEX       (0u)
#define SPI_1_TX_SCL_MISO_PIN_INDEX       (1u)
...
/* Pins settings mask. */
#define SPI_1_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << SPI_1_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define SPI_1_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << SPI_1_RX_SDA_MOSI_PIN_INDEX)
#define SPI_1_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << SPI_1_TX_SCL_MISO_PIN_INDEX)
...
#if (SPI_1_TX_SCL_MISO_PIN)
    #define SPI_1_CHECK_TX_SCL_MISO_PIN_USED \
                (SPI_1_PIN_DM_ALG_HIZ != \
                    SPI_1_GET_P4_PIN_DM(SPI_1_uart_tx_i2c_scl_spi_miso_PC, \
                                                   SPI_1_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (SPI_1_TX_SCL_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define SPI_1_SET_I2C_SCL_DR(val) \
                            SPI_1_uart_rx_wake_i2c_sda_spi_mosi_Write(val)

    #define SPI_1_SET_I2C_SCL_HSIOM_SEL(sel) \
                    SPI_1_SET_HSIOM_SEL(SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG,  \
                                                   SPI_1_RX_WAKE_SDA_MOSI_HSIOM_MASK, \
                                                   SPI_1_RX_WAKE_SDA_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define SPI_1_WAIT_SCL_SET_HIGH  (0u == SPI_1_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (SPI_1_RX_SDA_MOSI_PIN)
    #define SPI_1_SET_I2C_SCL_DR(val) \
                            SPI_1_uart_rx_i2c_sda_spi_mosi_Write(val)


    #define SPI_1_SET_I2C_SCL_HSIOM_SEL(sel) \
                            SPI_1_SET_HSIOM_SEL(SPI_1_RX_SDA_MOSI_HSIOM_REG,  \
                                                           SPI_1_RX_SDA_MOSI_HSIOM_MASK, \
                                                           SPI_1_RX_SDA_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define SPI_1_WAIT_SCL_SET_HIGH  (0u == SPI_1_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (SPI_1_TX_SCL_MISO_PIN)
    #define SPI_1_WAIT_SDA_SET_HIGH  (0u == SPI_1_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Clear UART wakeup source */
    ...
    #define SPI_1_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) SPI_1_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt(); \
            }while(0)
...
/* Unconfigured pins */
#define SPI_1_REMOVE_MOSI_SCL_RX_WAKE_PIN    SPI_1_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define SPI_1_REMOVE_MOSI_SCL_RX_PIN         SPI_1_REMOVE_RX_SDA_MOSI_PIN
#define SPI_1_REMOVE_MISO_SDA_TX_PIN         SPI_1_REMOVE_TX_SCL_MISO_PIN
...
/* Unconfigured pins */
#define SPI_1_MOSI_SCL_RX_WAKE_PIN   SPI_1_RX_WAKE_SDA_MOSI_PIN
#define SPI_1_MOSI_SCL_RX_PIN        SPI_1_RX_SDA_MOSI_PIN
#define SPI_1_MISO_SDA_TX_PIN        SPI_1_TX_SCL_MISO_PIN
...
#define SPI_1_SS0_PIN                SPI_1_RTS_SS0_PIN
    ...
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_REG     SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_PTR     SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_MASK    SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SPI_1_MOSI_SCL_RX_WAKE_HSIOM_POS     SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_REG    SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_PTR    SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SPI_1_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  SPI_1_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (SPI_1_RX_WAKE_SDA_MOSI_PIN) */

#if (SPI_1_MOSI_SCL_RX_PIN)
    #define SPI_1_MOSI_SCL_RX_HSIOM_REG      SPI_1_RX_SDA_MOSI_HSIOM_REG
    #define SPI_1_MOSI_SCL_RX_HSIOM_PTR      SPI_1_RX_SDA_MOSI_HSIOM_PTR
    #define SPI_1_MOSI_SCL_RX_HSIOM_MASK     SPI_1_RX_SDA_MOSI_HSIOM_MASK
    #define SPI_1_MOSI_SCL_RX_HSIOM_POS      SPI_1_RX_SDA_MOSI_HSIOM_POS
#endif /* (SPI_1_MOSI_SCL_RX_PIN) */

#if (SPI_1_MISO_SDA_TX_PIN)
    #define SPI_1_MISO_SDA_TX_HSIOM_REG      SPI_1_TX_SCL_MISO_HSIOM_REG
    #define SPI_1_MISO_SDA_TX_HSIOM_PTR      SPI_1_TX_SCL_MISO_HSIOM_REG
    #define SPI_1_MISO_SDA_TX_HSIOM_MASK     SPI_1_TX_SCL_MISO_HSIOM_REG
    #define SPI_1_MISO_SDA_TX_HSIOM_POS      SPI_1_TX_SCL_MISO_HSIOM_REG
...
#define SPI_1_MOSI_SCL_RX_WAKE_PIN_INDEX SPI_1_RX_WAKE_SDA_MOSI_PIN_INDEX
#define SPI_1_MOSI_SCL_RX_PIN_INDEX      SPI_1_RX_SDA_MOSI_PIN_INDEX
#define SPI_1_MISO_SDA_TX_PIN_INDEX      SPI_1_TX_SCL_MISO_PIN_INDEX
...
#define SPI_1_MOSI_SCL_RX_WAKE_PIN_MASK SPI_1_RX_WAKE_SDA_MOSI_PIN_MASK
#define SPI_1_MOSI_SCL_RX_PIN_MASK      SPI_1_RX_SDA_MOSI_PIN_MASK
#define SPI_1_MISO_SDA_TX_PIN_MASK      SPI_1_TX_SCL_MISO_PIN_MASK
