...
static void ssd1331_write_byte(uint8_t chData, uint8_t chCmd) 
{
    ...
    /* Set Slave Select Low & Transmit Data */
    SPI_Master_SpiUartWriteTxData(chData);
...
/**
  ...
  * @param  chXpos: Specifies the X position
  * @param  chYpos: Specifies the Y position
  * @param  pchBmp: Pointer to a image to display on the screen 
  * @param  chWidth: Specifies the width of the image
  * @param  chHeight: Specifies the height of the image
  * @param  hwColor: Specifies the color of the image
  *         
  * @retval  None
**/
...
void ssd1331_init(void)
{
    ...
    ssd1331_write_byte(SET_REMAP, SSD1331_CMD);          
    ssd1331_write_byte(0x72, SSD1331_CMD);             
    ...
    //ssd1331_write_byte(ENTIRE_DISPLAY_ON, SSD1331_CMD);
