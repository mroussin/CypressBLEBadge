...
#define SCB_EZI2C_PRIMARY_SLAVE_ADDRESS    (8u)
#define SCB_EZI2C_SECONDARY_SLAVE_ADDRESS  (9u)
#define SCB_EZI2C_SUB_ADDRESS_SIZE         (1u)
#define SCB_EZI2C_WAKE_ENABLE              (0u)
#define SCB_EZI2C_DATA_RATE                (400u)
#define SCB_EZI2C_SLAVE_ADDRESS_MASK       (254u)
