...
#define CYBLE_BADGE_SERVICE_INDEX   (0x00u) /* Index of Badge service in the cyBle_customs array */
#define CYBLE_BADGE_NAME_STRING_CHAR_INDEX   (0x00u) /* Index of Name String characteristic */
#define CYBLE_BADGE_NAME_STRING_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_BADGE_COLOR_STRING_CHAR_INDEX   (0x01u) /* Index of Color String characteristic */
#define CYBLE_BADGE_COLOR_STRING_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_BADGE_IMAGE_STRING_CHAR_INDEX   (0x02u) /* Index of Image String characteristic */
#define CYBLE_BADGE_IMAGE_STRING_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_BADGE_CURRENT_TIME_CHAR_INDEX   (0x03u) /* Index of Current Time characteristic */


#define CYBLE_BADGE_SERVICE_HANDLE   (0x0010u) /* Handle of Badge service */
#define CYBLE_BADGE_NAME_STRING_DECL_HANDLE   (0x0011u) /* Handle of Name String characteristic declaration */
#define CYBLE_BADGE_NAME_STRING_CHAR_HANDLE   (0x0012u) /* Handle of Name String characteristic */
#define CYBLE_BADGE_NAME_STRING_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_BADGE_COLOR_STRING_DECL_HANDLE   (0x0014u) /* Handle of Color String characteristic declaration */
#define CYBLE_BADGE_COLOR_STRING_CHAR_HANDLE   (0x0015u) /* Handle of Color String characteristic */
#define CYBLE_BADGE_COLOR_STRING_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0016u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_BADGE_IMAGE_STRING_DECL_HANDLE   (0x0017u) /* Handle of Image String characteristic declaration */
#define CYBLE_BADGE_IMAGE_STRING_CHAR_HANDLE   (0x0018u) /* Handle of Image String characteristic */
#define CYBLE_BADGE_IMAGE_STRING_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0019u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_BADGE_CURRENT_TIME_DECL_HANDLE   (0x001Au) /* Handle of Current Time characteristic declaration */
#define CYBLE_BADGE_CURRENT_TIME_CHAR_HANDLE   (0x001Bu) /* Handle of Current Time characteristic */
