...
module top ;
	...
	wire [0:0] tmpOE__LCD_DC_net;
	wire [0:0] tmpFB_0__LCD_DC_net;
	wire [0:0] tmpIO_0__LCD_DC_net;
	wire [0:0] tmpINTERRUPT_0__LCD_DC_net;
	electrical [0:0] tmpSIOVREF__LCD_DC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LCD_DC
		 (.oe(tmpOE__LCD_DC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD_DC_net[0:0]}),
		  .io({tmpIO_0__LCD_DC_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_DC_net),
		  .interrupt({tmpINTERRUPT_0__LCD_DC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD_DC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LCD_Reset_net;
	wire [0:0] tmpFB_0__LCD_Reset_net;
	wire [0:0] tmpIO_0__LCD_Reset_net;
	wire [0:0] tmpINTERRUPT_0__LCD_Reset_net;
	electrical [0:0] tmpSIOVREF__LCD_Reset_net;

	cy_psoc3_pins_v1_10
		#(.id("1825d13a-070a-46b6-b82e-624a99e2ab6c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LCD_Reset
		 (.oe(tmpOE__LCD_Reset_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD_Reset_net[0:0]}),
		  .io({tmpIO_0__LCD_Reset_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_Reset_net),
		  .interrupt({tmpINTERRUPT_0__LCD_Reset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
