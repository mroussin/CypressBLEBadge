...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Badge service */
    {
        0x0010u, /* Handle of the Badge service */ 
        {

            /* Name String characteristic */
            {
                0x0012u, /* Handle of the Name String characteristic */ 
            ...
            /* Color String characteristic */
            {
                0x0015u, /* Handle of the Color String characteristic */ 
            ...
            /* Image String characteristic */
            {
                0x0018u, /* Handle of the Image String characteristic */ 
            ...
            {
                0x001Bu, /* Handle of the Current Time characteristic */ 
