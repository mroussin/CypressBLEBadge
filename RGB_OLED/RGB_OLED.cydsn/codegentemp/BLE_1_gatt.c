    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x61u] = {
    /* Device Name */
    (uint8)'B', (uint8)'a', (uint8)'d', (uint8)'g', (uint8)'e',
    ...
    (uint8)'F', (uint8)'i', (uint8)'r', (uint8)'s', (uint8)'t', (uint8)' ', (uint8)'N', (uint8)'a', (uint8)'m',
    (uint8)'e',
    ...
    /* Characteristic User Description */
    (uint8)'F', (uint8)'a', (uint8)'v', (uint8)'o', (uint8)'r', (uint8)'i', (uint8)'t', (uint8)'e', (uint8)' ',
    ...
    /* Custom Descriptor */
    (uint8)'I', (uint8)'m', (uint8)'a', (uint8)'g', (uint8)'e', 0x2Du, 0xD8u, 0x1Bu, 0x7Eu, 0x3Du, 0x05u, 0x98u, 0x8Eu,
    0xC6u, 0x4Eu, 0x4Eu, 0x31u, 0x03u, 0xFDu, 0xE9u, 0xC8u,
...
const uint8 cyBle_attUuid128[][16u] = {
    /* Badge */
    { 0xD3u, 0xE6u, 0xEDu, 0x70u, 0xB8u, 0xE4u, 0x15u, 0x99u, 0xF7u, 0x4Cu, 0x17u, 0xD4u, 0xEDu, 0x7Eu, 0xB1u, 0x80u },
    /* Name String */
    { 0xDAu, 0x50u, 0xC8u, 0x63u, 0x65u, 0xA0u, 0x31u, 0xA4u, 0x03u, 0x49u, 0x19u, 0x4Cu, 0xFBu, 0x40u, 0x20u, 0xD7u },
    /* Color String */
    { 0xFDu, 0x50u, 0x5Bu, 0xECu, 0x68u, 0x84u, 0x61u, 0xBAu, 0x0Eu, 0x48u, 0x49u, 0xEEu, 0xCCu, 0x92u, 0x86u, 0x06u },
    /* Image String */
    { 0x89u, 0x49u, 0xDDu, 0x20u, 0x6Du, 0x1Bu, 0xACu, 0xB7u, 0xF5u, 0x43u, 0x02u, 0x64u, 0x10u, 0x0Cu, 0xABu, 0x04u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[15] }, /* Central Address Resolution */
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Badge UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Name String UUID */
    { 0x0008u, (void *)&cyBle_attValues[21] }, /* Name String */
    { 0x000Au, (void *)&cyBle_attValues[29] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* Color String UUID */
    { 0x0001u, (void *)&cyBle_attValues[39] }, /* Color String */
    { 0x000Eu, (void *)&cyBle_attValues[40] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* Image String UUID */
    { 0x000Cu, (void *)&cyBle_attValues[54] }, /* Image String */
    { 0x0005u, (void *)&cyBle_attValues[66] }, /* Custom Descriptor */
    { 0x000Au, (void *)&cyBle_attValues[87] }, /* Current Time */
};

const CYBLE_GATTS_DB_T cyBle_gattDB[0x1Bu] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x08000001u /*       */, 0x001Bu, {{0x0010u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x000A0001u /* rd,wr */, 0x0013u, {{0x0010u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0012u, 0x40FBu /* Name String                         */, 0x090A0101u /* rd,wr */, 0x0013u, {{0x0008u, (void *)&cyBle_attValuesLen[9]}} },
    ...
    { 0x0015u, 0x92CCu /* Color String                        */, 0x090A0101u /* rd,wr */, 0x0016u, {{0x0001u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0016u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0016u, {{0x000Eu, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00000001u /*       */, 0x0019u, {{0x0010u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0018u, 0x0C10u /* Image String                        */, 0x09000000u /*       */, 0x0019u, {{0x000Cu, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0019u, 0xFD03u /* Custom Descriptor                   */, 0x09000001u /*       */, 0x0019u, {{0x0005u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x001Au, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x001Bu, {{0x2A2Bu, NULL}}                           },
    { 0x001Bu, 0x2A2Bu /* Current Time                        */, 0x01020001u /* rd    */, 0x001Bu, {{0x000Au, (void *)&cyBle_attValuesLen[17]}} },
};
